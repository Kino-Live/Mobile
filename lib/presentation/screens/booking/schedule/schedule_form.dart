...
class ScheduleForm extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return RefreshIndicator(
      onRefresh: onRefresh ?? () async {}, // TODO: connect pull-to-refresh
...
class _ArrowStrip extends StatelessWidget {
  ...
  final Widget child; final VoidCallback onPrev; final VoidCallback onNext;
...
class _DayChips extends StatelessWidget {
  const _DayChips({required this.days, required this.selectedIndex, required this.onSelect});
  final List<String> days; final int selectedIndex; final void Function(int) onSelect;
...
class _TimeChips extends StatelessWidget {
  const _TimeChips({required this.isoList, required this.selectedIndex, required this.onSelect});
  final List<String> isoList; final int selectedIndex; final void Function(int) onSelect;
